...
public class FontanaBetSportsBw implements Serializable {
    private Long id;
    ...
    public void setReadip(String readip) {
        this.readip = readip == null ? null : readip.trim();
    }

    public String getBwplat() {
        return bwplat;
    }

    public void setBwplat(String bwplat) {
        this.bwplat = bwplat == null ? null : bwplat.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        FontanaBetSportsBw other = (FontanaBetSportsBw) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getAsync() == null ? other.getAsync() == null : this.getAsync().equals(other.getAsync()))
            && (this.getReadip() == null ? other.getReadip() == null : this.getReadip().equals(other.getReadip()))
            && (this.getBwplat() == null ? other.getBwplat() == null : this.getBwplat().equals(other.getBwplat()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getAsync() == null) ? 0 : getAsync().hashCode());
        result = prime * result + ((getReadip() == null) ? 0 : getReadip().hashCode());
        result = prime * result + ((getBwplat() == null) ? 0 : getBwplat().hashCode());
        return result;
    }
}